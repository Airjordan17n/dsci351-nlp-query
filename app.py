...
def execute_mysql_query(query):
    ssh_host = 'ec2-3-144-253-89.us-east-2.compute.amazonaws.com'
    ssh_user = 'ubuntu'
    ...
    #connection = pymysql.connect(
    #    host="ec2-3-144-253-89.us-east-2.compute.amazonaws.com",  # public IP or hostname
    #    user="root",
    #    password="Dsci351",
...
def execute_mongo_query(query, datasets_list):
    mongo_uri = "mongodb://ec2-3-144-253-89.us-east-2.compute.amazonaws.com:27017"
    try:
